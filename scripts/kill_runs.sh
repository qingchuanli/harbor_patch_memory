...
usage() {
    cat <<EOF
Usage: $0 (--variant {pm|baseline|terminus2_pm|terminus2-pm} | --all) [options]

  --variant {pm|baseline|terminus2_pm|terminus2-pm}
...
while [ $# -gt 0 ]; do
    case "$1" in
        ...
        --all)           VARIANTS=(pm baseline terminus2_pm terminus2-pm); shift ;;
